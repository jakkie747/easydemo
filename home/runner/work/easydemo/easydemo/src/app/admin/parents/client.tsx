...
function initializeFirebaseAdmin() {
  ...
  try {
    ...
    if (!serviceAccountKey || serviceAccountKey.includes("PASTE_YOUR")) {
      // Don't throw an error during build if the key isn't set.
      // Firestore rules will handle security on the client-side.
      console.warn('FIREBASE_SERVICE_ACCOUNT_KEY is not set correctly. Admin features will be unavailable.');
      return;
    }
