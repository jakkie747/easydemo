  ...
  return (
    <SidebarProvider defaultOpen>
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
            <AdminSidebar />
            <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-[--sidebar-width-icon] group-data-[state=expanded]/sidebar-wrapper:sm:pl-[--sidebar-width] transition-[padding-left]">
                <AdminHeader />
